...
struct jobList 
{
	...
	jobList():  need_average(false), need_rc(false), need_nl(false),
				need_binary_input(false), need_fresh_input(false), 
				need_text_out(false), need_binary_out(false),  
				need_trunc(false),  need_strikes_list(false), need_trace(false),
